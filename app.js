...
const mechanisms = [
  {
    ...
    base: 54,
    tags: ["trial", "awareness", "newCategory", "lowTrust", "offline", "online", "fmcg", "beauty", "saas", "complex", "revLow", "revMid"],
    avoid: ["lowMargin", "cashTight", "inventory"],
  ...
  },
  {
    ...
    base: 51,
    tags: ["conversion", "repeat", "retention", "midMargin", "highMargin", "fmcg", "retail", "ecom", "finance", "app", "crmReady", "revMid", "revHigh", "revEnterprise"],
    avoid: ["luxury", "veryHighIncome", "brandSensitive", "lowMargin"],
  ...
  },
  {
    ...
    base: 50,
    tags: ["aov", "traffic", "conversion", "retail", "ecom", "marketplace", "midMargin", "highMargin", "inventory", "lowAOV", "revLow", "revMid"],
    avoid: ["premiumPosition", "luxury", "noDiscount", "brandSensitive", "lowMargin"],
  ...
  },
  {
    ...
    base: 53,
    tags: ["aov", "inventory", "value", "retail", "ecom", "service", "saas", "lowAOV", "stock", "midMargin", "highMargin", "revLow", "revMid", "revHigh"],
  ...
  },
  {
    ...
    base: 56,
    tags: ["repeat", "retention", "data", "reactivation", "alwaysOn", "long", "crmReady", "app", "retail", "ecom", "finance", "horeca", "beauty", "revHigh", "revEnterprise"],
  ...
  },
  {
    ...
    base: 52,
    tags: ["referral", "highCAC", "lowTrust", "community", "saas", "service", "finance", "education", "subscription", "crmReady", "online", "revMid", "revHigh"],
    avoid: ["lowTrust", "noCRM", "legalSensitive"],
  ...
  },
  {
    ...
    base: 46,
    tags: ["awareness", "traffic", "data", "fmcg", "retail", "ecom", "young", "fun", "lowBudget", "midBudget", "short", "season", "revLow", "revMid"],
    avoid: ["legalSensitive", "luxury", "brandSensitive", "b2b"],
  ...
  },
  {
    ...
    base: 45,
    tags: ["awareness", "community", "fun", "young", "adult", "online", "social", "premiumImage", "data", "lowAwareness", "revMid", "revHigh"],
  ...
  },
  {
    ...
    base: 49,
    tags: ["premiumImage", "premium", "luxury", "innovation", "community", "highIncome", "veryHighIncome", "brandSensitive", "noDiscount", "awareness", "revHigh", "revEnterprise"],
    avoid: ["inventory", "stock", "economy", "lowTrust"],
  ...
  },
  {
    ...
    base: 48,
    tags: ["conversion", "traffic", "reactivation", "ecom", "marketplace", "online", "lowBudget", "fastLaunch", "lowConversion", "cashTight", "revLow", "revMid"],
    avoid: ["premiumPosition", "luxury", "brandSensitive", "noDiscount"],
  ...
  },
  {
    ...
    base: 47,
    tags: ["durable", "auto", "retail", "electronics", "conversion", "traffic", "eco", "highMargin", "complex", "offline", "revMid", "revHigh", "revEnterprise"],
  ...
  },
  {
    ...
    base: 52,
    tags: ["subscription", "saas", "education", "service", "trial", "conversion", "retention", "online", "app", "complex", "revLow", "revMid", "revHigh"],
  ...
  },
  {
    ...
    base: 47,
    tags: ["app", "online", "repeat", "retention", "data", "young", "adult", "fun", "community", "alwaysOn", "loyalty", "revHigh", "revEnterprise"],
  ...
  },
  {
    ...
    base: 49,
    tags: ["partners", "awareness", "premiumImage", "highIncome", "service", "finance", "travel", "retail", "noDiscount", "brandSensitive", "revHigh", "revEnterprise"],
  ...
  },
  {
    ...
    base: 42,
    tags: ["eco", "premiumImage", "community", "awareness", "highIncome", "veryHighIncome", "female", "adult", "matureAdult", "brandSensitive", "revMid", "revHigh", "revEnterprise"],
    avoid: ["priceWar", "cashTight", "lowTrust"],
  ...
  },
  {
    ...
    base: 50,
    tags: ["durable", "complex", "conversion", "highIncome", "middleIncome", "auto", "realEstate", "electronics", "noDiscount", "premiumPosition", "revMid", "revHigh", "revEnterprise"],
  ...
  },
  {
    ...
    base: 48,
    tags: ["lowTrust", "complex", "service", "education", "saas", "conversion", "premiumPosition", "expert", "newCategory", "revLow", "revMid", "revHigh"],
    avoid: ["lowOps", "cashTight", "fmcg"],
